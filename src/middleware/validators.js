...
export const validateSignup = [
  ...
  body("customRoleTitle").optional({ checkFalsy: true }).isString().trim(),
...
export const validatePatient = [
  ...
  body("phone").trim().notEmpty().withMessage("Phone number is required").matches(/^[0-9+\-() ]*$/).withMessage("Phone contains invalid characters"),
  body("address").trim().notEmpty().withMessage("Address is required").isString().withMessage("Address must be text"),
  handleValidationErrors,
];
