          ...
          const createdPatient = await tx.patient.create({
            data: {
              ...
              ...toEncryptedPatientData({
                ...
                nextOfKinName: pendingIntake.nextOfKinName,
                nextOfKinPhone: pendingIntake.nextOfKinPhone,
                nextOfKinRelationship: pendingIntake.nextOfKinRelationship,
                nextOfKinAddress: pendingIntake.nextOfKinAddress,
